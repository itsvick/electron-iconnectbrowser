...
const APP_DIR = path.resolve(path.join(__dirname, 'release-builds', 'win64/'));
// outputDirectory: "C:\\Users\sdkca\Code\app_installer", 
const OUT_DIR = path.resolve(path.join(__dirname, 'release-builds', 'win64/windows-installer-msi'));
